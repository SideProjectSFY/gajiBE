...
public interface MessageMapper {
    ...
    @Insert("""
        ...
        VALUES (#{id}, #{conversation.id}, #{sender.id}, #{role}, #{content}, NOW())
        """)
    ...
    @Results(id = "MessageResult", value = {
        ...
        @Result(property = "conversation", column = "conversation_id", 
                one = @One(select = "com.gaji.corebackend.repository.ConversationMapper.findById")),
        @Result(property = "sender", column = "sender_id",
                one = @One(select = "com.gaji.corebackend.repository.UserMapper.findById")),
